...
{
    long double value {};
    std::vector<std::uint8_t> buffer = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
...
{
    std::string value {};
    std::vector<std::uint8_t> buffer = { 0x0C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
...
{
    std::string value {};
    std::vector<std::uint8_t> buffer = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0C, 
                                         0x48, 0x65, 0x6C, 0x6C, 0x6F, 0x20, 0x57, 0x6F, 
                                         0x72, 0x6C, 0x64, 0x21 };
    std::size_t offset = 0;
    EXPECT_TRUE(DeserializeBinary(value, buffer, offset, utility::Endianness::BigEndian));
